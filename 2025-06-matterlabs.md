...
| ------------------------- | ----------------------------------------------- | ----------------------------------------------- | ----------------------------------------------- |
| <span class="border rounded px-1">High</span>   | **<span style="color: #ef4444; margin: 0;">Critical</span>** | **<span style="color: #f97316; margin: 0;">High</span>**   | **<span style="color: #fbc02d; margin: 0;">Medium</span>** |
| <span class="border rounded px-1">Medium</span> | **<span style="color: #f97316; margin: 0;">High</span>**     | **<span style="color: #fbc02d; margin: 0;">Medium</span>** | **<span style="color: #84cc16; margin: 0;">Low</span>**    |
| <span class="border rounded px-1">Low</span>    | **<span style="color: #fbc02d; margin: 0;">Medium</span>**   | **<span style="color: #84cc16; margin: 0;">Low</span>**    | **<span style="color: #22c55e; margin: 0;">QA</span>**     |
...
- <span style="color: #fbc02d; margin: 0;">Notified</span> indicates that the client has been informed of the issue but has either not addressed it yet or has acknowledged the behavior without planning to remediate it soon. This inaction may stem from the client not viewing the behavior as problematic, lacking a feasible solution, or intending to address it at a later date.
- <span style="color: #00acc1; margin: 0;">Addressed</span> is used when the client has made an effort to address the issue with partial success. In the case of complex issues, the provided fix may only resolve one of several points described.
- <span style="color: #10b981; margin: 0;">Fixed</span> means that the client has implemented a solution that completely resolves the described issue.
